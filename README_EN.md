...
- **Service probes** — URL / TCP / DNS / ICMP / Push kinds, Gatus-style conditions (status code + keyword + max latency + cert days left) and dual-threshold debounce; heartbeat strips; status badges as SVG
